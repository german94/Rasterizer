...
void escalando(Model* data, int swidth, int sheight)
{
	...
	Vec4Mat4ProductASM(maxx, data->wvp, resx, aux);
	...
	Vec4Mat4ProductASM(maxy, data->wvp, resy, aux);
...
{	
    ...
    {   	   
	    ...
	    Vec4Mat4ProductASM(vertexA, data->wvp, res1, aux);
	    v1[0] = (res1[0]/res1[3])*sf->w + sf->w*0.5 ;
	    v1[1] = (-res1[1]/res1[3])*sf->h+ sf->h*0.7; 
	    v1[2] = res1[2] / res1[3];

	    Vec4Mat4ProductASM(vertexB, data->wvp, res2, aux);
	    v2[0] = (res2[0]/res2[3])*sf->w + sf->w*0.5 ;
	    v2[1] = (-res2[1]/res2[3])*sf->h + sf->h*0.7; 
	    v2[2] = res2[2] / res2[3];

	    Vec4Mat4ProductASM(vertexC, data->wvp, res3, aux);
	    ...
	    v3[1] = (-res3[1]/res3[3])*sf->h + sf->h*0.7; 
	 	...
	 	///////////////////////////
 		Vec4Mat4ProductASM(vertexA, data->world, p1.wcoordinates, aux);
        Vec4Mat4ProductASM(vertexB, data->world, p2.wcoordinates, aux);
        Vec4Mat4ProductASM(vertexC, data->world, p3.wcoordinates, aux);
        ...
        Vec4Mat4ProductASM(vertexAn, data->world, p1.normal, aux);
        Vec4Mat4ProductASM(vertexBn, data->world, p2.normal, aux);
        Vec4Mat4ProductASM(vertexCn, data->world, p3.normal, aux);
